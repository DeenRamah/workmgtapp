  ...
  return (
    <>
      ...
      <Typography variant="caption" sx={{ display: "block", mt: 2 }}>
        Created by <Link href="https://buymeacoffee.com/deenramah44">0Deen & Emmah</Link> <br />
        Explore the project on GitHub:{" "}
        <Link href="https://github.com/0Deen/DeemahApp" target="_blank" rel="noopener noreferrer">
          Todo Deemah App Repository
        </Link>
      </Typography>
